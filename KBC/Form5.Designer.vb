...
Partial Class Form5
    ...
    Private Sub InitializeComponent()
        ...
        Button3.Location = New Point(442, 394)
        ...
        Button4.Location = New Point(102, 395)
        Button4.Name = "Button4"
        Button4.Size = New Size(241, 35)
        Button4.TabIndex = 13
        Button4.Text = "C) Valves"
        ...
        Label1.TabIndex = 10
        Label1.Text = "Q4) What hardware was used by frist genration Computer  ?"
        ' 
        ' ProgressBar1
        ' 
        ProgressBar1.BackColor = SystemColors.ControlDark
        ProgressBar1.ForeColor = Color.Yellow
        ProgressBar1.Location = New Point(162, 21)
